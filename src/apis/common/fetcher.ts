...
//   //   await this.request('http://localhost:8080/api/users/check-session', { skipSessionCheck: true })
//   // }
...
//     if (!skipSessionCheck && url !== 'http://localhost:8080/api/users/check-session') {
